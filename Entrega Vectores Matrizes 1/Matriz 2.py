# Realice un algoritmo que permita hacer un ahorcadito, la matriz permitirá almacenar las palabras,
# se recomienda que las palabras tengan el mismo tamaño para evitar reasignar el valor o tamaño de la matriz.
